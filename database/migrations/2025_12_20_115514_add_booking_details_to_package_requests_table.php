...
return new class extends Migration
{
    ...
    {
        Schema::table('package_requests', function (Blueprint $table) {
            $table->dropColumn(['booking_name', 'booking_email', 'booking_phone', 'relation', 'is_for_self', 'address']);
        });
    }
};
