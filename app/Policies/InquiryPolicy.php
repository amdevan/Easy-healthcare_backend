...
class InquiryPolicy
{
    ...
    {
        return $user->hasPermission('view_inquiries');
    }
    ...
    {
        return $user->hasPermission('create_inquiries');
    }
    ...
    {
        return $user->hasPermission('edit_inquiries');
    }
    ...
    {
        return $user->hasPermission('delete_inquiries');
    }
