...
class SpecialtyPolicy
{
    ...
    {
        return $user->hasPermission('view_specialties');
    }
    ...
    {
        return $user->hasPermission('create_specialties');
    }
     ...
     */
    public function restore(User $user, Specialty $model): bool
    {
        return $user->hasPermission('edit_specialties');
    }
     ...
     */
    public function forceDelete(User $user, Specialty $model): bool
    {
        return $user->hasPermission('delete_specialties');
    }
}